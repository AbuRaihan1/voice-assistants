...
function read(text) {
  ...
  if (text== 'hi'){
    ...
    (" Raihan Ahmed Makes me");
  } else if (text == "who is shiblu gf") {
    (" haha. its a weard question. if i said this, i think shiblu will heart me. but, i don't have to do anything. Raihan Ahmed called me to say this. so, i have to say this Name. Shiblu's gf name is Rima");
